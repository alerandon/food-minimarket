  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container mx-auto flex h-14 md:h-16 items-center justify-between px-3 md:px-6">
        <Link href="/stores" className="flex items-center gap-1.5 md:gap-2 font-bold text-lg md:text-xl text-primary hover:text-primary/80 transition-colors">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          <Link
            ...
            className={cn(
              ...
              "hover:text-primary transition-colors hidden sm:inline"
            )}
          >
            Tiendas
          </Link>
          ...
          <Button asChild className="gap-1.5 md:gap-2 h-9 md:h-10 px-3 md:px-4" size="sm">
            <Link href="/login">
